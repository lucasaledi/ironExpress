package com.aledluca.ironExpress.security;

import com.aledluca.ironExpress.exception.LoginException;
import com.aledluca.ironExpress.security.filters.CustomAuthorizationFilter;
import com.aledluca.ironExpress.security.filters.CustomAuthenticationFilter;
...
public class SecurityConfiguration {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                //.requestMatchers(HttpMethod.GET, "/api/get-tasks").hasAnyAuthority("ROLE_ADMIN","ROLE_SELLER","ROLE_CUSTOMER")
                //.requestMatchers(HttpMethod.GET,"/api/customers/**").hasAnyAuthority("ROLE_CUSTOMER")
                //.requestMatchers(HttpMethod.POST,"/api/sellers/**").hasAnyAuthority("ROLE_SELLER")
                //.anyRequest().authenticated()
                .requestMatchers("/customer**").hasAnyRole("ROLE_ADMIN", "ROLE_CUSTOMER")
                .requestMatchers("/seller**").hasAnyRole("ROLE_ADMIN","ROLE_SELLER")
                .anyRequest().authenticated()
        );
